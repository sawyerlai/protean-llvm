...
define dso_local i32 @foo(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %x.pub = call preserve_allcc ptr @llvm.protean.declassify.p0(ptr %0)
  %2 = load i32, ptr %0, align 4, !tbaa !5
  %3 = icmp sgt i32 %2, -1
  br i1 %3, label %4, label %8

4:                                                ; preds = %1
  %y.pub = call preserve_allcc i32 @llvm.protean.declassify.i32(i32 %2)
  %5 = zext i32 %2 to i64
  %z.pub = call preserve_allcc i64 @llvm.protean.declassify.i64(i64 %5)
  %6 = getelementptr inbounds [16 x i32], ptr @A, i64 0, i64 %5
  %a.pub = call preserve_allcc ptr @llvm.protean.declassify.p0(ptr %6)
